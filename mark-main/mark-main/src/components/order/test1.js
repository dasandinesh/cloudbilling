    ...
    return (
        <div className="mobile-sale-container">
           <div className="main-grid">
            ...
            <h6 style={{textAlign: "center", marginBottom: '20px'}}>Mobile Sale Entry</h6>
        ...
        <div style={{ marginBottom: '20px' }}>
                ...
                <div className="bill-details-grid">
                    ...
                    <div>
                        <p style={{ margin: '0 0 5px 0', fontWeight: 'bold' }}>Total Commission:</p>
                        <input
                            type="number"
                    ...
                    <div>
                        ...
                        />
                                ...
                                <div><button type="submit" className="submit-button">{formMode === 'EDIT' ? 'Sale Bill Update' : formMode === 'CONVERT' ? 'Sale Bill Convert' : 'Submit'}</button>
                 </div>
