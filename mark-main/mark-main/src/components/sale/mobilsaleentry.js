...
const MobileSaleEntry = () => {
            ...
            async function sendDataToRealm(arg1, formData) {
              ...
              try {
                ...
                const response = await axios.put(
                  // `${URL_SALE_update}?arg1=${arg1}`,payload);
                  URL_SALE_update,
                  payload
                );
    ...
    return (
        <div className="mobile-sale-container">
           <div className="main-grid">
            <div className="bill-form">
            <h6 style={{textAlign: "center", marginBottom: '3px'}}>Mobile Sale Entry</h6>
            ...
            <div className="bill-top">
                ...
                <div className="bill-details-grid">
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>Transport:</p>
                        <input
                            type="text"
                    ...
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>Total Quantity:</p>
                        <input
                            type="number"
                    ...
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>Total Bag Price:</p>
                        <input
                            type="text"
                    ...
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>Total Wages:</p>
                        <input
                            type="number"
                    ...
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>T/Comm:</p>
                        <input
                            type="number"
                    ...
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>Credit:</p>
                        <input
                            type="number"
                    ...
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>Cash:</p>
                        <input
                            type="number"
                    ...
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>Old Balance:</p>
                        <input
                            type="number"
                            ...
                            readOnly
                            className=" mediumInput readonly-input"
                        />
                    </div>
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>New Balance:</p>
                        <input
                            type="number"
                    ...
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>Subtotal:</p>
                        <input
                            type="number"
                    ...
                    <div>
                        <p style={{ margin: '0 0 0 0', fontWeight: 'bold' }}>Bill Amount:</p>
                        <input
                            type="number"
            ...
            <button type="submit" className="submit-button">{formMode === 'EDIT' ? 'Sale Bill Update' : formMode === 'CONVERT' ? 'Sale Bill Convert' : 'Submit'}</button>
                 <button type="button" className="action-button" onClick={handlePreviousBill} disabled={currentSaleIndex <= 0}>
                        Previous
                    </button>
                    <button type="button" className="action-button" onClick={handleNextBill} disabled={currentSaleIndex === -1 || currentSaleIndex >= SaleList.length - 1}>
                        Next
                    </button>
                    <button
                        type="button"
                        ...
                        {orderList && orderList.length > 0 ? (
                            orderList.map((sale, index) => (
                                <tr key={sale._id || index}>
                                    ...
                                    <td>
                                        <button className="icon-button" onClick={() => handleSelectOrder(sale)}>
                                            <FaRegEdit />
                                        </button>
                                    </td>
                                    <td>
                        ...
                        {SaleList && SaleList.length > 0 ? (
                            SaleList.map((sale, index) => (
                                <tr key={sale._id || index}>
                                    ...
                                    <td>
                                        <button className="icon-button" onClick={() => handleEditSale(sale)}>
                                            <FaRegEdit />
                                        </button>
                                    </td>
                                    <td>
