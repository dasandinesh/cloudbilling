...
import PurchasePrintPre from "./PurchasePrintPre.js";
...
const PurchaseReturn = () => {
  ...
  // purchase bill preview modal enable
  const [showPurchasePrintPre, setShowPurchasePrintPre] = useState(false);
  ...
  const billDetails = watch("bill_details");
  ...
  // Auto-calculate Grand Total on form
  useEffect(() => {
    const subtotal = parseFloat(billDetails?.bill_amount || 0) || 0;
    const discount = parseFloat(billDetails?.discount || 0) || 0;
    const transport = parseFloat(billDetails?.transport || 0) || 0;
    const roundoff = parseFloat(billDetails?.round_off || 0) || 0;
    const grand = subtotal - discount + transport + roundoff;
    setValue("bill_details.grand_total", grand.toFixed(2));
  }, [billDetails?.bill_amount, billDetails?.discount, billDetails?.transport, billDetails?.round_off, setValue]);
  ...
  return (
    <div className="main-grid">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="bill-top">
              ...
              <div>
                ...
                <p>
                  <h6>Purchase No:</h6>
                  <input type="text" {...register("bill_details.bill_no")} />
                </p>
                </div>  
                <div style={{ float: "left", marginLeft: "10px" }}>
                <p>Supplier GSTIN:</p>
                <input
                  type="text"
                  {...register("bill_details.supplier_gstin")}
                  placeholder="GSTIN"
                  className="date"
                />
              </div>
          ...
          <div className="table-wrapper">
            <table>
              <thead style={{ backgroundColor: "#f3f4f6", textAlign: "center" }}>
                <tr style={{ textAlign: "center" }}>
                  ...
                  <th style={{ textAlign: "center" }}>gstpre</th>
                  <th style={{ textAlign: "center" }}>cprice</th>
                  <th style={{ textAlign: "center" }}>cprice_total</th>
                  <th style={{ textAlign: "center" }}>Scale</th>
                  <th style={{ textAlign: "center" }}>Cgst</th>
                  <th style={{ textAlign: "center" }}>sgst</th>
                  <th style={{ textAlign: "center" }}>scaleno</th>
                  <th style={{ textAlign: "center" }}>bagprice</th>
            ...
            <div>
              ...
              <div>
                ...
                <input
                  ...
                  type="number"
                  step="0.01"
                  {...register("bill_details.discount")}
              ...
              <div>
                ...
                <input
                  ...
                  type="number"
                  step="0.01"
                  {...register("bill_details.round_off")}
              ...
              <div>
                ...
                <input
                  className="mobilevies"
                  type="number"
                  {...register("bill_details.grand_total")}
            ...
            <div>
              <div>
                ...
                <input
                  className="mobilevies"
                  type="text"
                  {...register("bill_details.payment_mode")}
              ...
              <div>
                ...
                <input
                  className="mobilevies"
                  type="text"
                  {...register("bill_details.payment_ref")}
          ...
          <center>
            ...
            <button
              className="buttonb"
              type="button"
              onClick={() => setShowPurchasePrintPre(true)}
            >
              Preview / Print Bill
            </button>
          </center>
      ...
      {showPurchasePrintPre && (
        <PurchasePrintPre bill={getValues()} onClose={() => setShowPurchasePrintPre(false)} />
      )}
