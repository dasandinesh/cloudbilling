...
const estimatesorderSchema = new mongoose.Schema({
    userId: { 
...
estimatesorderSchema.pre('save', async function(next) {
...
const EstimatesorderModel = mongoose.model('estimatesorder', estimatesorderSchema);
// Also expose the schema so tenant-aware controllers can bind it to req.tenantConn
EstimatesorderModel.estimatesorderSchema = estimatesorderSchema;

module.exports = EstimatesorderModel;
